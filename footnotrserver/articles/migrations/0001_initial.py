...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'articles_comment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('annotation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['articles.Annotation'])),
    ...
    models = {
        ...
        u'articles.comment': {
            ...
            'annotation': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['articles.Annotation']"}),
