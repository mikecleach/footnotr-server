...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.creator'
        db.add_column(u'articles_article', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, related_name='articles', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.creator'
        db.delete_column(u'articles_article', 'creator_id')
